...
<body class="admin-body pwa-page antialiased min-h-screen">
    ...
    <div class="mobile-drawer" id="mobileDrawer">
        ...
        <div class="p-4 mt-auto" style="border-top: 1px solid rgba(248,246,241,0.08);">
            ...
            <form method="POST" action="{{ route('admin.logout') }}" data-logout-form @submit.prevent="if(window.DayOSSync){DayOSSync.clear().then(()=>$el.submit())}else{$el.submit()}">
                @csrf
    ...
    <div class="min-h-screen flex">
        ...
        <aside class="hidden lg:flex flex-col w-64 admin-sidebar sticky top-0 h-screen">
            ...
            <div class="p-4" style="border-top: 1px solid rgba(248,246,241,0.08);">
                ...
                <form method="POST" action="{{ route('admin.logout') }}" class="mt-2" data-logout-form @submit.prevent="if(window.DayOSSync){DayOSSync.clear().then(()=>$el.submit())}else{$el.submit()}">
                    @csrf
